    ...
    return (
        <>
            ...
            <main>
                ...
                <div className="group">
                    {Object.entries(
                        allWritings.filter(filterDraft).reduce<{ [year: string]: Writing[] }>((ac, v) => {
                        ...
                        .map(([year, postList], i) => {
                            return (
                                <div key={year} data-animate data-animate-stage={i + 1} className="relative border-t">
                                    <h3 className="absolute top-3 -z-10 text-sm text-gray-9">{year}</h3>
                                    {postList
